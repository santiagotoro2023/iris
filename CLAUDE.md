...
- [~] Phase 6 — Integrations & Tools: **web search + vision/document analysis done** (`searxng` + `web_search` tool; `api/files.py` with qwen2.5vl for images, pypdf/python-docx for documents). Email/calendar/WhatsApp/transit/location not started
